...
var G__29301 = devtools.prefs.pref(v);
v = G__29301;
continue;
} else {
return v;
...
}catch (e29267){var _e__26572__auto__ = e29267;
return false;
}})();
...
}catch (e29276){var _e__26572__auto__ = e29276;
return false;
}})();
...
}catch (e29278){var _e__26572__auto__ = e29278;
return false;
}}
}
});
...
var vec__29286 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29286,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29286,(1),null);
...
return cljs.core.some((function (p1__29291_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29291_SHARP_);
}),template);
});
