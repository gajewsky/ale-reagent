...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29415){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29423_SHARP_){
return (!((cljs.core.meta(p1__29423_SHARP_) == null)));
})))){
...
var map__29424 = opts;
var map__29424__$1 = (((((!((map__29424 == null))))?(((((map__29424.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29424.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29424):map__29424);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29424__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29428){var _e__26572__auto__ = e29428;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e29430){var _e__26572__auto__ = e29430;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29432 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29433 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29433;

try{var map__29434 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29434__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29432;
}});
...
;
var temp__5733__auto___29510 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29510)){
var managed_print_level_29511 = temp__5733__auto___29510;
var _STAR_print_level_STAR__orig_val__29452_29512 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29453_29513 = managed_print_level_29511;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29453_29513;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__29452_29512,_STAR_print_level_STAR__temp_val__29453_29513,managed_print_level_29511,temp__5733__auto___29510,writer,opts,job_fn){
return (function (p1__29441_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29441_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__29452_29512,_STAR_print_level_STAR__temp_val__29453_29513,managed_print_level_29511,temp__5733__auto___29510,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29452_29512;
}} else {
job_fn();
}
