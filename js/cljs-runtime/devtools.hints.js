...
var G__26767 = cljs.core.PersistentArrayMap.EMPTY;
var G__26768 = native_stack_trace;
var G__26769 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__26770 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__26767,G__26768,G__26769,G__26770) : cljs.stacktrace.parse_stacktrace.call(null,G__26767,G__26768,G__26769,G__26770));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26772__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26772__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26772__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e26771){var _e = e26771;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___26937 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___26937)){
var seen_errors_26938 = temp__5733__auto___26937;
if(cljs.core.truth_(seen_errors_26938.has(self))){
} else {
seen_errors_26938.add(self);

var temp__5735__auto___26939 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___26939)){
var sense_26940 = temp__5735__auto___26939;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26940)].join('');
} else {
}
}
} else {
