...
var G__37653 = o;
(G__37653[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37689__delegate = function (args){
...
while (G__37690__i < G__37690__a.length) {G__37690__a[G__37690__i] = arguments[G__37690__i + 0]; ++G__37690__i;}
  args = new cljs.core.IndexedSeq(G__37690__a,0,null);
} 
return G__37689__delegate.call(this,args);};
G__37689.cljs$lang$maxFixedArity = 0;
G__37689.cljs$lang$applyTo = (function (arglist__37691){
var args = cljs.core.seq(arglist__37691);
return G__37689__delegate(args);
});
...
var G__37657 = o;
(G__37657[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__37693__i < G__37693__a.length) {G__37693__a[G__37693__i] = arguments[G__37693__i + 0]; ++G__37693__i;}
  args = new cljs.core.IndexedSeq(G__37693__a,0,null);
} 
...
var G__37660 = props;
var G__37660__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37660,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37660);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37660__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37661){
...
var props = map__37662__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37662__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37664){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37665__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37665,map__37665__$1,on_write){
return (function (){
...
});})(node_value,map__37665,map__37665__$1,on_write))
);
} else {
...
var G__37668 = jsprops;
(G__37668["defaultValue"] = value);

(G__37668["onChange"] = ((function (G__37668,v,value,on_change){
return (function (p1__37667_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37667_SHARP_);
});})(G__37668,v,value,on_change))
);
...
var vec__37670 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37670,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37670,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37670,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___37709 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37709 == null)){
} else {
var key_37710 = temp__5739__auto___37709;
(jsprops["key"] = key_37710);
}
...
var temp__5739__auto___37711 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___37711 == null)){
} else {
var key_37712 = temp__5739__auto___37711;
reagent.impl.template.oset(jsprops,"key",key_37712);
}
...
var G__37674 = reagent.impl.template.__GT_NativeWrapper();
(G__37674["name"] = c);
...
var G__37675 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37675) : reagent.impl.template.as_element.call(null,G__37675));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37678){
var G__37679 = cljs.core.first(seq37678);
var seq37678__$1 = cljs.core.next(seq37678);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37679,seq37678__$1);
});
...
break;
default:
var G__37722 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37722;
continue;
...
var n__4607__auto___37726 = a.length;
var i_37728 = (0);
while(true){
if((i_37728 < n__4607__auto___37726)){
(a[i_37728] = reagent.impl.template.as_element((a[i_37728])));

var G__37732 = (i_37728 + (1));
i_37728 = G__37732;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___37733 = a.length;
var i_37734 = (0);
while(true){
if((i_37734 < n__4607__auto___37733)){
var val_37735 = (a[i_37734]);
if(((cljs.core.vector_QMARK_(val_37735)) && ((reagent.impl.template.key_from_vec(val_37735) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37734] = reagent.impl.template.as_element(val_37735));

var G__37736 = (i_37734 + (1));
i_37734 = G__37736;
continue;
} else {
}
...
var ctx = ({});
var vec__37682 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37682,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37682,(1),null);
...
var G__37685 = (cljs.core.count(argv) - first_child);
switch (G__37685) {
case (0):
...
case (1):
var G__37686 = comp;
var G__37687 = jsprops;
var G__37688 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37686,G__37687,G__37688);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__37685){
