...
var o29130 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29130["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29131 = temp__5733__auto____$1;
return (o29131["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26532__auto__ = f;
return (o__26532__auto__["toString"]).call(o__26532__auto__);
} else {
return "";
}
}catch (e29132){var _ = e29132;
return "";
}});
...
try{var o__26532__auto___29257 = t;
(o__26532__auto___29257["cljs$lang$ctorPrWriter"]).call(o__26532__auto___29257,t,writer);
}catch (e29133){var __29258 = e29133;
}
...
var char_code = (function (){var o__26532__auto__ = (new String(char$));
return (o__26532__auto__["charCodeAt"]).call(o__26532__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26532__auto__ = String;
return (o__26532__auto__["fromCharCode"]).call(o__26532__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29141 = num_code;
switch (G__29141) {
case (1):
return (185);
...
var o__26532__auto__ = String;
return (o__26532__auto__["fromCharCode"]).call(o__26532__auto__,superscript_code);
});
/**
...
}catch (e29146){var _e__26572__auto__ = e29146;
return false;
}})())){
...
var vec__29147 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29147,(0),null);
...
var or__4131__auto__ = (function (){var temp__5733__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5733__auto__)){
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29157 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29157["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29158 = temp__5733__auto____$1;
return (o29158["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29161){
var vec__29162 = p__29161;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29162,(0),null);
...
var G__29265 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29266 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29265;
remaining_tokens = G__29266;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29159){
var G__29160 = cljs.core.first(seq29159);
var seq29159__$1 = cljs.core.next(seq29159);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29160,seq29159__$1);
});
...
var vec__29167 = cljs.core.split_with((function (p1__29166_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29166_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29167,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29167,(1),null);
...
var vec__29173 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29173,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29173,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29272 = cljs.core.rest(remaining_tokens);
var G__29273 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29272;
name_tokens = G__29273;
continue;
} else {
...
var vec__29178 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29178,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29178,(1),null);
var vec__29181 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29181,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29181,(1),null);
var vec__29184 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29184,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29184,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29184,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29184,(3),null);
...
var vec__29189 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29189,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29189,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29189,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29189,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29189,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29189,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__29192 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29192,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29192,(1),null);
var vec__29195 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29195,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29195,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29198 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29198) : devtools.munging.parse_fn_info_deep.call(null,G__29198));
})()));
}
} else {
return fn_info;
...
var G__29280 = (arity + (1));
var G__29281 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29199){
var vec__29200 = p__29199;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29200,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29200,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29204_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29205_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29209){
var vec__29210 = p__29209;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29210,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29207){
var G__29208 = cljs.core.first(seq29207);
var seq29207__$1 = cljs.core.next(seq29207);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29208,seq29207__$1);
});
...
var G__29213 = arg;
var G__29213__$1 = (((G__29213 instanceof cljs.core.Keyword))?G__29213.fqn:null);
switch (G__29213__$1) {
...
var map__29214 = options;
var map__29214__$1 = (((((!((map__29214 == null))))?(((((map__29214.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29214.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29214):map__29214);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29214__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29214__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29214__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29214__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29215 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29215,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29215,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29215,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29215,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29215,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29215,(5),null);
...
var o__26532__auto__ = f;
return (o__26532__auto__["getBasis"]).call(o__26532__auto__);
});
/**
...
}catch (e29220){var _e__26572__auto__ = e29220;
...
var G__29289 = (obj[cljs.core.first(path)]);
var G__29290 = cljs.core.rest(path);
obj = G__29289;
path = G__29290;
continue;
} else {
...
return (function (accum,p__29227){
var vec__29228 = p__29227;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29228,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29228,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29231){
var vec__29232 = p__29231;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29232,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29232,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29232,(2),null);
...
return (function (p__29237){
var vec__29238 = p__29237;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29238,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29238,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__29238,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29235_SHARP_){
return (obj[cljs.core.first(p1__29235_SHARP_)]);
});})(name,sorted_matches,vec__29238,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
